...
def main_worker(gpu, world_size, dist_url):
    ...
    for i_iter in range(args.num_steps):
        ...
        if gpu == 0 and i_iter >= args.num_steps_stop - 1:
            ...
            save_file = {'model_I1_state_dict': model_B2.state_dict(), 'model_I2_state_dict': model_B.state_dict(), \
                'Ihead_state_dict': head.state_dict(), 'Iclassifier_state_dict': classifier.state_dict()}
